...
%feature("director:except",fullname=1) Foo::ping {
  if (ExceptionMatches(jenv,$thrown,"$packagepath/MyJavaException1")) {
    ...
    std::string msg = GetExceptionMessage(jenv,$thrown);
